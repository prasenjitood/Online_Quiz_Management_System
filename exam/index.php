...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="university" name="university" placeholder="Enter your university name" class="form-control input-md" type="text">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<h4 style="font-family:'typo' ">onlineQuiz.com</h4>
