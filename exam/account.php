...
$c++;
echo '<tr><td style="color:#99cc32"><b>'.$c.'</b></td><td>'.$name.'</td><td>'.$gender.'</td><td>'.$university.'</td><td>'.$s.'</td><td>';
}
echo '</table></div></div>';}
?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121.jpg" width=100 height=100 alt="Prasenjit Chowdhury, Naimul Azim , Shanjid Mohammad" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">sam</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+8801878778782</h4>
		<h4 style="font-family:'typo' ">prasenjit@gmail.com</h4>
		<h4 style="font-family:'typo' ">IIUC</h4></div></div>
		</p>
      </div>
